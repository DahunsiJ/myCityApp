...
//app.initialize();  App.controller('home', function (page) {
        // put stuff here
        App.controller("home", function (page) {
          $(document).ready(function () {
            var rootUrl = "https://justandusweb.000webhostapp.com"
        
        
            const url = ` 
        https://justandusweb.000webhostapp.com/wp-json/wp/v2/posts`;
        
        
            var tokenUrl = ` ${rootUrl}/wp-json/jwt-auth/v1/token`;
        
            var adminDet = {
              username: "dahunsijustus06@gmail.com",
              password: "DahJust1998",
            };
